...
def test_query_linter_lints_queries_and_stores_dfsas(simple_ctx, ws, sql_backend, make_ws_query):
    query = make_ws_query(query_text="SELECT * from csv.`dbfs://some_folder/some_file.csv`")
