...
def test_job_crawler(ws, make_job, inventory_catalog, inventory_schema, sql_backend):
    new_job = make_job(spark_conf=_SPARK_CONF)
    job_crawler = JobsCrawler(ws=ws, sbe=sql_backend, catalog=inventory_catalog, schema=inventory_schema)
