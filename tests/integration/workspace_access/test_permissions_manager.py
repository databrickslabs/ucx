...
def test_permissions_snapshot(ws, sql_backend, inventory_schema, inventory_catalog):
    ...
    permission_manager = PermissionManager(sql_backend, inventory_catalog, inventory_schema, [StubbedCrawler()])
