...
def test_replace_workspace_groups_with_account_groups(ws, sql_backend, inventory_schema, make_ucx_group, make_table):
    ws_group, _ = make_ucx_group()
    logger.info("test_replace_workspace_groups_with_account_groups() Testing setting permissions on a database object.")
