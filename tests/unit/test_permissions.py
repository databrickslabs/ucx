import json
import pytest
from databricks.sdk.service.iam import Group, ObjectPermissions, AccessControlResponse
        ...
        (
            PermissionsInventoryItem(
                ...
                raw_object_permissions=json.dumps(
                        ObjectPermissions(
                            object_id="clusterid1", object_type="clusters", access_control_list=[
            ...
            PermissionsInventoryItem(
                ...
                raw_object_permissions=json.dumps(
                        ObjectPermissions(
                            object_id="passwords", object_type="authorization", access_control_list=[
                                AccessControlResponse.from_dict(
                                    {"all_permissions": [{"permission_level": "CAN_MANAGE"}], "group_name": "group1"})
                            ]
                        ).as_dict()
           ...
           PermissionsInventoryItem(
                ...
                raw_object_permissions=json.dumps(
                        ObjectPermissions(
                            object_id="tokens", object_type="authorization", access_control_list=[
                                AccessControlResponse.from_dict(
                                    {"all_permissions": [{"permission_level": "CAN_MANAGE"}], "group_name": "group1"})
                            ]
                        ).as_dict()
            ...
            PermissionsInventoryItem(
                ...
                raw_object_permissions=json.dumps(
                        ObjectPermissions(
                            object_id="notebook1", object_type="notebooks", access_control_list=[
                                AccessControlResponse.from_dict(
