...
def test_not_migrated_tables_trigger_nothing(empty_index, dst_lookup):
    lookup = dst_lookup(empty_index)
    ftf = FromTable(lookup)
...
def test_migrated_tables_trigger_messages(migration_index, dst_lookup):
...
def test_fully_migrated_queries_match(migration_index, dst_lookup):
    ftf = FromTable(dst_lookup(migration_index))
...
def test_fully_migrated_queries_match_no_db(migration_index, dst_lookup):
    ftf = FromTable(dst_lookup(migration_index), use_schema="old")
