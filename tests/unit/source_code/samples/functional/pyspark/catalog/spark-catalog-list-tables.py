...
# ucx[table-migrate:+1:13:+1:39] Call to 'listTables' will return a list of <catalog>.<database>.<table> instead of <database>.<table>.
for table in spark.catalog.listTables():
    do_stuff_with_table(table)

## Check that we generate a warning when we reference a migrated database.
# ucx[table-migrate:+3:13:+3:44] Call to 'listTables' will return a list of <catalog>.<database>.<table> instead of <database>.<table>.
## TODO: The following isn't yet implemented:
## ucx[table-migrate:+1:13:+1:0] Database 'old' is migrated to 'brand.new' in Unity Catalog
...
# ucx[table-migrate:+1:13:+1:48] Call to 'listTables' will return a list of <catalog>.<database>.<table> instead of <database>.<table>.
...
# ucx[table-migrate:+1:13:+1:68] Call to 'listTables' will return a list of <catalog>.<database>.<table> instead of <database>.<table>.
...
# ucx[table-migrate:+3:13:+3:66] Call to 'listTables' will return a list of <catalog>.<database>.<table> instead of <database>.<table>.
## TODO: The following isn't yet implemented:
## ucx[table-migrate:+1:13:+1:0] Database 'old' is migrated to 'brand.new' in Unity Catalog
...
# ucx[table-migrate:+1:0:+1:39] Call to 'listTables' will return a list of <catalog>.<database>.<table> instead of <database>.<table>.
