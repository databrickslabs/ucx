...
for i in range(10):
    ...
    # ucx[table-migrated-to-uc-python:+1:4:+1:37] Table old.things is migrated to brand.new.stuff in Unity Catalog
    ...
    # ucx[table-migrated-to-uc-python:+1:4:+1:63] Table old.things is migrated to brand.new.stuff in Unity Catalog
