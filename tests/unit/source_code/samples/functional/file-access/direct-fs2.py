...
for i in range(10):
    # ucx[table-migrated-to-uc-sql:+1:13:+1:50] Table old.things is migrated to brand.new.stuff in Unity Catalog
...
# ucx[table-migrated-to-uc-sql:+3:4:+3:20] Table old.things is migrated to brand.new.stuff in Unity Catalog
table_name = f"table_{index}"
