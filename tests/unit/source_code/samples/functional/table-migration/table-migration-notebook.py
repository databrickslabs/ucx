...
# ucx[table-migrated-to-uc-python:+2:8:+2:29] Table people is migrated to cata4.nondefault.newpeople in Unity Catalog
...
# ucx[table-migrated-to-uc-python:+2:8:+2:30] Table persons is migrated to cata4.newsomething.persons in Unity Catalog
...
# ucx[table-migrated-to-uc-python:+2:8:+2:30] Table kittens is migrated to cata4.felines.toms in Unity Catalog
# ucx[default-format-changed-in-dbr8:+1:8:+1:30] The default format changed in Databricks Runtime 8.0, from Parquet to Delta
