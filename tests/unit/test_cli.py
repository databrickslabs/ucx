...
def ws():
    state = {
        ...
        "/Users/foo/.ucx/azure_storage_account_info.csv": "prefix,client_id,principal,privilege,type,default_network_action,directory_id\ntest,test,test,test,Application,Allow,test",
