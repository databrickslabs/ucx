...
## Workflow assessment
This task retrieves the jobs to analyze their notebooks and files for [migration problems](/docs/reference/linter_codes). This will run for workflows that ran within the last 30 days.
To analyze all workflows run the [migration-progress-experimental](/docs/reference/workflows#experimental-migration-progress-workflow) workflow.
