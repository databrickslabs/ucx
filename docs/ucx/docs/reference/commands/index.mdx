...
These commands are for the [pipeline migration process](/docs/process/#pipeline-migration-process) and require the [assessment workflow](/docs/reference/workflows#assessment-workflow) to be completed.
...
One pre-requisite for the pipeline migration process is to have the DLT clone API to be enabled for the workspace.
