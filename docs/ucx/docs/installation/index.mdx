...
### Assessment and ownership configuration

**Skip workflow assessment?**
- **Default**: No (workflows will be assessed)
- **Purpose**: Workflow assessment identifies code that needs updates for Unity Catalog compatibility
