...
from databricks.labs.ucx.source_code.python.python_ast import PythonSequentialLinter, Tree
...
class _CollectorWalker(DependencyGraphWalker[S], ABC):
    """Collect source info's while walking the dependencies."""
