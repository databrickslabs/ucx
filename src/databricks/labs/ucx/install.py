...
class WorkspaceInstaller(WorkspaceContext):
    ...
    def _prompt_for_new_installation(self) -> WorkspaceConfig:
        ...
        inventory_catalog = self.prompts.question("Inventory Catalog", default=default_catalog, valid_regex=r"^\w+$")
        inventory_database = self.prompts.question(
            f"Inventory Database stored in {inventory_catalog}", default=default_database, valid_regex=r"^\w+$"
        )
