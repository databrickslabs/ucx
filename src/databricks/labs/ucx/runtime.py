...
from databricks.labs.ucx.framework.tasks import Task, TaskLogger, parse_args, Workflow
...
class Workflows:
    ...
    def trigger(self, *argv):
        ...
        if task_name == "parse_logs":
            if workflow != "099-destroy-schema":  # Cannot store logs after schema is destroyed
