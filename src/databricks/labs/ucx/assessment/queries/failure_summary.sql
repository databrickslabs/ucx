-- viz type=table, name=Failure Summary, columns=component, issue_count, issue_percentage_jobs, issue_percentage_clusters, issue_percentage_gis, issue_percentage_pipelines
