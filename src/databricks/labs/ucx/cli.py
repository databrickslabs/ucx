...
def migrate_credentials(w: WorkspaceClient, prompts: Prompts, ctx: WorkspaceContext | None = None, **named_parameters):
    ...
    Databricks, to UC storage credentials, and it creates UC storage credentials for the access connectors with a
    ...
    use Databricks' best practice for using access connectors to authenticate with external storage.
