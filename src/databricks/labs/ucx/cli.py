...
@ucx.command
def migrate_azure_sp(w: WorkspaceClient, new_csv_path: str, replace_with_access_connector: bool):
    ...
    make a copy of it and pass in the path of the copied and updated file.
