...
@ucx.command
def migrate_azure_service_principals(w: WorkspaceClient):
    ...
    which is generated by save_azure_storage_accounts command. Please review the file and delete the Service Principals
