...
- [ ] Tokens (token permissions are set on the workspace level. It basically says "this group can use tokens or not")
- [ ] Passwords (only for AWS, it defines which groups can log in with passwords)
- [ ] Secrets
