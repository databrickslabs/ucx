...
#### Step 3: Migrate tables and views:
...
starting the workflows from the workspace UI manually. Before running the migration workflow, chose the strategies
for migrating tables using the table below:
