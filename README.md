...
access the configuration file from the command line. Here's the description of configuration properties:
  ...
  * `is_terraform_used`: A boolean value indicating whether Terraform is used for resources provisioning.
  * `grant_migration_strategy`: An optional string representing the grant migration strategy.
