...
with NamedTemporaryFile(suffix="-uc-upgrade-requirements.txt") as requirements_file:
    ...
    ipython.run_line_magic("pip", f"install -r {requirements_file.name}")
...
try:
    ...
    print(f"Successfully loaded the uc-upgrade package")
except Exception as e:
    print(
        "Unable to import the UC migration utilities package from source. Please check that you've imported the whole repository and not just copied one file."
    )
